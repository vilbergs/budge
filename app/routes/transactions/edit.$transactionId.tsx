...
export const action: ActionFunction = async ({ request }) => {
  ...
  if (typeof id !== 'string' || id.length === 0) {
    return json<ActionData>({ errors: {} }, { status: 500 })
  }
...
export default function NewTransactionPage() {
  ...
  const [transactionFrequency, setTransactionFrequency] =
    useState<TransactionFrequency>(transaction.frequency)
        ...
        <div>
          ...
          <div className="mt-1">
            <input
              ...
              className="block h-8 w-full rounded-md border border-gray-300 p-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
        ...
        <div>
          ...
          <div className="mt-1">
            <input
              ...
              defaultValue={
                transaction.date
                  ? formatDate(new Date(transaction.date), 'yyyy-MM-dd')
                  : ''
              }
              aria-invalid={actionData?.errors?.amount ? true : undefined}
              aria-errormessage={
